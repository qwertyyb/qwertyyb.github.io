...
![JSON.parse 后精度丢失](/assets/JSON%20长数字处理/51ad4469-5813-414b-8008-09c6a4900100.png)
...
![JSON.parse 的原函数签名](/assets/JSON%20长数字处理/5ced6a9c-51f7-477a-907c-f772c8f7393e.png)

`JSON.parse source text access` 提案的具体内容是在 `receiver` 中追加了第三个参数，第三个参数是一个对象，对象中有一个字段 `source` 指向了 JSON 字符串的原始值。

![JSON.parse 第三个参数](/assets/JSON%20长数字处理/13e88bf0-eda9-4414-a7d3-4b79cc93da15.png)
